#!/usr/bin/env python3
"""
Fixed script to install required packages using venv_ninja_moltbot
"""
...
def install_packages():
    ...
    if not os.path.exists(python_path):
        print(f"ERREUR: Le fichier n'existe pas: {python_path}")
        
        # Try alternative paths
        alt_paths = [
            "..\\venv_ninja_moltbot\\Scripts\\python.exe",
            "..\\..\\..\\venv_ninja_moltbot\\Scripts\\python.exe",
            "..\\..\\..\\..\\venv_ninja_moltbot\\Scripts\\python.exe"
        ]
        ...
        for alt_path in alt_paths:
            ...
            if os.path.exists(alt_path):
                ...
                print(f"Trouve alternative: {python_path}")
                break
        else:
